...
def new_world(player):
	print("Welcome to the wonderful world of Pokemon! Through some method or another to be decided later, you got a Pokemon! You're getting a Bulbasaur, to be precise.")
	...
	testBulba.set_trainer(player) ## TEST
	player.add_pokemon(testBulba) ## TEST
	testBulba.set_room(home_master_bedroom)
